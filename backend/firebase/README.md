# سرویس اعتبار و تشخیص امن (Legacy)

> ⚠️ **این بک‌اند دیگر مسیر اصلی نیست.** پروژه به یک بک‌اند رایگان و بدون نیاز به
> Google Cloud Billing مهاجرت کرده: **Cloudflare Workers + D1**
> (رجوع کنید به [`backend/cloudflare/worker/README.md`](../cloudflare/worker/README.md)).
> کد این پوشه فقط برای سازگاری/بازگشت احتمالی نگه داشته شده و در
> `SmartMechanicApp.kt` آخرین اولویت فعال را دارد (بعد از Cloudflare). برای
> پروژه‌های جدید از اینجا شروع نکنید.
